      ...
      <div className='auth-inner py-2'>
        <Card className='mb-0'>
          <CardBody>
            ...
            <Form className='auth-login-form mt-2' onSubmit={e => e.preventDefault()}> { /*e.preventDefault()*/ }
              <FormGroup>
              ...
              <Button.Ripple color='primary' block onClick={() => window.location.replace('/report/HistoricalReport')}>
                Sign in
              </Button.Ripple>
            </Form>
